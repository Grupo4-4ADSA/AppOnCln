...
class MainActivity : AppCompatActivity(), NavigationHost {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (savedInstanceState == null) {
            ...
            supportFragmentManager
                ...
                .add(R.id.nav_fragment_container, setLayoutMenu(R.id.layout_home,R.layout.activity_home), "navbarBottom")
                .commit()
        }
    }
    ...
    override fun navigateTo(fragment: Fragment, addToBackStack: Boolean, layout: Int) {
        ...
        val transaction: FragmentTransaction = supportFragmentManager
            ...
            .replace(R.id.nav_fragment_container, setLayoutMenu(layout,backScreen.setBackLayout), "screenValue")
