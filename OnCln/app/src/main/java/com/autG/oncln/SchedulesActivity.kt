...
import com.autG.oncln.dtos.responses.Schedules
import com.autG.oncln.dtos.responses.SchedulesItem
import com.autG.oncln.services.Auth
import com.autG.oncln.services.NavigationHost
import com.autG.schedule.adapter.ScheduleAdapter
...
internal class SchedulesActivity : Fragment() {
    ...
    private lateinit var arrayList: ArrayList<SchedulesItem>
    ...
    private fun requestSchedule() {
        ...
        authRequest.requestSchedules(cacheLogin).enqueue(
            object : Callback<Schedules?> {
                override fun onResponse(
                    ...
                    if (response.isSuccessful) {
                        ...
                        binding.recycleListRoom.adapter = ScheduleAdapter(
                            arrayList,
                            getText(R.string.title_input_floor).toString(),
                            requireContext(),
                            { id ->
//                                (activity as NavigationHost).navigateTo(
//                                    EditSchedulingActivity(id), addToBackStack = true,
